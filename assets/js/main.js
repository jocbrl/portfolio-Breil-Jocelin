/*==================== MENU SHOW Y HIDDEN ====================*/
let demoButtons = document.querySelectorAll('.demo-button'); // Get all demo buttons

demoButtons.forEach(button => {
   button.addEventListener('click', function() {
      let demoText = this.nextElementSibling; // Get the next element (your text area)
      demoText.style.display = 'block'; // Make the text area visible
   });
});
...
// Ajouter la classe darkTheme au corps de la page pour le thème sombre par défaut
